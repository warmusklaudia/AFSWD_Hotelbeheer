    ...
    <RouteHolder title="Reservation">
        ...
        <div v-else-if="result" class="grid md:grid-cols-2">
            <div class="order-last md:order-first">
                ...
                <ul class="grid">
                    <li v-for="r of result.reservation.room">
                        <h2 class="font-title font-bold text-2xl mb-3">{{ r.name }}</h2>
                        <div class="grid md:grid-cols-[auto_1fr] gap-6">
                            ...
                            <div class="grid grid-rows-[1fr_auto] gap-3">
                                <p class="font-theme">{{ r.description }}</p>
                                <p class="text-lg">Price: € {{ r.price }}</p>
                            </div>
                        </div>
                    </li>
