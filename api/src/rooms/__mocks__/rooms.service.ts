...
export const RoomsService = jest.fn().mockReturnValue({
  ...
  findRoomsWithoutReservation: jest.fn().mockResolvedValue([createRoom()]),
  update: jest.fn().mockResolvedValue(createRoom()),
  findByString: jest.fn().mockResolvedValue([createRoom()]),
  removeReservationFromRoom: jest.fn().mockResolvedValue(createRoom()),
  addReservationToRoom: jest.fn().mockResolvedValue(createRoom()),
